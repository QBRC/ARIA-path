...
!function (u) {
    u.extend = function () {
        var e, t, i, n, o, r = arguments[0] || {}, s = arguments.length, a = !1, l = 1;
        if ("boolean" == typeof r) {
            a = r;
            r = arguments[1] || {};
            l = 2
        ...
        for (; l < s; l++) if (null !== (e = arguments[l]) || void 0 !== e) for (t in e) {
            var h = Object.getOwnPropertyDescriptor(e, t);
            if (void 0 !== h) {
                if (h.get || h.set) Object.defineProperty(r, t, h); else if (r !== (i = h.value)) if (a && i && (OpenSeadragon.isPlainObject(i) || (n = OpenSeadragon.isArray(i)))) {
                    h = r[t];
                    if (n) {
                        n = !1;
    ...
    u.extend(u, {
        ...
        getElementOffset: function (e) {
            var t, i = (e = u.getElement(e)) && e.ownerDocument, n = {top: 0, left: 0};
        ...
        setElementOpacity: function (e, t, i) {
            ...
            if (u.Browser.opacity) e.style.opacity = t < 1 ? t : ""; else if (t < 1) {
                t = Math.round(100 * t);
        ...
        normalizeEventListenerOptions: function (e) {
            return void 0 !== e ? "boolean" == typeof e ? u.supportsEventListenerOptions ? {capture: e} : e : u.supportsEventListenerOptions ? e : void 0 !== e.capture && e.capture : !!u.supportsEventListenerOptions && {capture: !1}
        },
        addEvent: function () {
        ...
        jsonp: function (e) {
            var i, t = e.url, n = document.head || document.getElementsByTagName("head")[0] || document.documentElement,
                o = e.callbackName || "openseadragon" + u.now(), r = window[o], s = e.param || "callback",
                a = e.callback;
            t = t.replace(/(=)\?(&|$)|\?\?/i, "$1" + o + "$2");
            t += (/\?/.test(t) ? "&" : "?") + s + "=" + o;
            window[o] = function (e) {
                if (r) window[o] = r; else try {
                    delete window[o]
                } catch (e) {
                }
    ...
    !function () {
        ...
        switch (navigator.appName) {
            case"Microsoft Internet Explorer":
                ...
                break;
            case"Netscape":
                if (window.addEventListener) if (0 <= t.indexOf("Edge")) {
...
!function (a) {
    ...
    a.EventSource.prototype = {
        addOnceHandler: function (t, i, e, n, o) {
            ...
            o || (this.events[e] = o = []);
            if (t && a.isFunction(t)) {
                var r = o.length, s = {handler: t, userData: i || null, priority: n || 0};
                o[r] = s;
...
!function (c) {
    ...
    function b(e, t) {
        ...
        o.shouldCapture && (n ? L(e, i, !0) : function (e, t) {
            var i;
            if (c.MouseTracker.havePointerCapture) if (c.MouseTracker.havePointerEvents) try {
                e.element.setPointerCapture(t.id)
            } catch (e) {
                c.console.warn("setPointerCapture() called on invalid pointer ID");
                return
            } else e.element.setCapture(!0); else {
                i = p(e, c.MouseTracker.havePointerEvents ? "pointerevent" : t.type);
    ...
    function I(e, t) {
        ...
        var n = {
            originalEvent: t,
            eventType: "pointerup",
            pointerType: (i = {id: m(t), type: v(t), isPrimary: f(t), currentPos: y(t), currentTime: c.now()}).type,
            isEmulated: !1
        };
        B(e, n);
        A(e, n, i, t.button);
    ...
    function A(e, t, i, n) {
        ...
        if (0 === n) {
            ...
            if (!t.preventGesture && !t.defaultPrevented) if (h) {
...
!function (m) {
    ...
    m.extend(m.Viewer.prototype, m.EventSource.prototype, m.ControlDock.prototype, {
        isOpen: function () {
            ...
            if (c[this.hash]) {
                ...
                if (this.buttonGroup) this.buttonGroup.destroy(); else if (this.customButtons) for (; this.customButtons.length;) this.customButtons.pop().destroy();
            ...
            if (m.isArray(i.tileSource)) setTimeout(function () {
                ...
                !function (i, n, o, r, s) {
                    var a = i;
                    if ("string" === m.type(n)) if (n.match(/^\s*<.*>\s*$/)) n = m.parseXml(n); else if (n.match(/^\s*[{[].*[}\]]\s*$/)) try {
                        var e = m.parseJSON(n);
                        n = e
                    } catch (e) {
                    }
            ...
            var e = m.delegate(this, v), t = m.delegate(this, f), i = m.delegate(this, this.goToNextPage),
                n = m.delegate(this, this.goToPreviousPage), o = this.navImages, r = !0;
            ...
            var e = m.delegate(this, L), t = m.delegate(this, M), i = m.delegate(this, N), n = m.delegate(this, F),
                o = m.delegate(this, A), r = m.delegate(this, U), s = m.delegate(this, V), a = m.delegate(this, j),
                l = m.delegate(this, G), h = m.delegate(this, q), c = m.delegate(this, v), u = m.delegate(this, f),
                d = this.navImages, p = [], g = !0;
    ...
    function h(e, t) {
        ...
        var i = null;
        if (t.element) i = m.getElement(t.element); else {
    ...
    function p(e) {
        ...
        if (t.preventDefaultAction || e.ctrl || e.alt || e.meta) e.preventDefault = !1; else switch (e.keyCode) {
            case 38:
            ...
            case 68:
                ...
                break;
            case 82:
                e.shift ? this.viewport.flipped ? this.viewport.setRotation(this.viewport.getRotation() + this.rotationIncrement) : this.viewport.setRotation(this.viewport.getRotation() - this.rotationIncrement) : this.viewport.flipped ? this.viewport.setRotation(this.viewport.getRotation() - this.rotationIncrement) : this.viewport.setRotation(this.viewport.getRotation() + this.rotationIncrement);
                this.viewport.applyConstraints();
                e.preventDefault = !0;
                break;
            case 70:
    ...
    function y(e) {
        ...
        if (!t.preventDefaultAction && this.viewport && e.quick) {
            ...
            if (t.dblClickDragToZoom) if (!0 === c[this.hash].draggingToZoom) {
    ...
    function T(e) {
        ...
        if (!i.preventDefaultAction && this.viewport) if (t.dblClickDragToZoom && c[this.hash].draggingToZoom) {
        ...
        !function (e) {
            if (!e._opening && c[e.hash]) {
                if (e.autoResize || c[e.hash].forceResize) {
                    ...
                    c[e.hash].needsResize && function (e, t) {
                        var i = e.viewport;
                        var n = i.getZoom();
                        var o = i.getCenter();
                        ...
                        i.panTo(o, !0);
                        var r;
                        if (e.preserveImageSizeOnResize) r = c[e.hash].prevContainerSize.x / t.x; else {
...
!function (r) {
    r.Navigator = function (i) {
        ...
        if (i.element || i.id) {
            ...
            if (i.position) if ("BOTTOM_RIGHT" === i.position) i.controlOptions.anchor = r.ControlAnchor.BOTTOM_RIGHT; else if ("BOTTOM_LEFT" === i.position) i.controlOptions.anchor = r.ControlAnchor.BOTTOM_LEFT; else if ("TOP_RIGHT" === i.position) i.controlOptions.anchor = r.ControlAnchor.TOP_RIGHT; else if ("TOP_LEFT" === i.position) i.controlOptions.anchor = r.ControlAnchor.TOP_LEFT; else if ("ABSOLUTE" === i.position) {
...
!function (h) {
    h.TileSource = function (e, t, i, n, o, r) {
        ...
        h.extend(!0, this, l);
        if (!this.success) for (a = 0; a < arguments.length; a++) if (h.isFunction(arguments[a])) {
    ...
    h.TileSource.prototype = {
        getTileSize: function (e) {
            ...
            var t = this.getLevelScale(e), i = Math.ceil(t * this.dimensions.x / this.getTileWidth(e)),
                e = Math.ceil(t * this.dimensions.y / this.getTileHeight(e));
            return new h.Point(i, e)
        }, getPixelRatio: function (e) {
            var t = this.dimensions.times(this.getLevelScale(e)), e = 1 / t.x * h.pixelDensityRatio,
            ...
            var o = this.dimensions.times(this.getLevelScale(e)), r = this.getTileWidth(e), s = this.getTileHeight(e),
                a = 0 === t ? 0 : r * t - this.tileOverlap, e = 0 === i ? 0 : s * i - this.tileOverlap,
                t = r + (0 === t ? 1 : 2) * this.tileOverlap, s = s + (0 === i ? 1 : 2) * this.tileOverlap, i = 1 / o.x;
            t = Math.min(t, o.x - a);
            s = Math.min(s, o.y - e);
            ...
            if (t.loadWithAjax) i.request = h.makeAjaxRequest({
                url: t.src,
...
!function (p) {
    ...
    p.extend(p.DziTileSource.prototype, p.TileSource.prototype, {
        supports: function (e, t) {
            ...
            e = (p.isPlainObject(e) ? u : function (e, t) {
                ...
                var i, n, o, r, s, a = t.documentElement, l = a.localName || a.tagName,
                    h = t.documentElement.namespaceURI, t = null, c = [];
                if ("Image" === l) try {
    ...
    function u(e, t) {
        var i, n, o = t.Image, r = o.Url, s = o.Format, a = o.Size, l = o.DisplayRect || [], h = parseInt(a.Width, 10),
            c = parseInt(a.Height, 10), a = parseInt(o.TileSize, 10), o = parseInt(o.Overlap, 10), u = [];
...
!function (h) {
    h.IIIFTileSource = function (e) {
        ...
        if (this.tile_width && this.tile_height) {
        ...
        } else if (this.tile_width) e.tileSize = this.tile_width; else if (this.tile_height) e.tileSize = this.tile_height; else if (this.tiles) if (1 === this.tiles.length) {
            ...
            var o = Math.min(this.height, this.width), r = [256, 512, 1024], s = [];
        ...
        if (!e.maxLevel && !this.emulateLegacyImagePyramid) if (this.scale_factors) {
    ...
    h.extend(h.IIIFTileSource.prototype, h.TileSource.prototype, {
        supports: function (e, t) {
            ...
            if (h.isPlainObject(e)) {
                if (e["@context"]) {
                    var n = e["@context"];
                    if (Array.isArray(n)) for (var o = 0; o < n.length; o++) if ("string" == typeof n[o] && (/^http:\/\/iiif\.io\/api\/image\/[1-3]\/context\.json$/.test(n[o]) || "http://library.stanford.edu/iiif/image-api/1.1/context.json" === n[o])) {
                        n = n[o];
                        break
                    }
                    switch (n) {
                ...
                if (e.preferredFormats) for (var r = 0; r < e.preferredFormats.length; r++) if (OpenSeadragon.imageFormatSupported(e.preferredFormats[r])) {
            ...
            if (this.levelSizes) {
                ...
                var i = Math.ceil(t.width / this.getTileWidth(e)), t = Math.ceil(t.height / this.getTileHeight(e));
            ...
            var o, r, s, a, l, h, c, u, d = Math.pow(.5, this.maxLevel - e);
            if (this.levelSizes) {
    ...
    function c(e) {
        ...
        var i = -1 !== ["http://library.stanford.edu/iiif/image-api/compliance.html#level0", "http://library.stanford.edu/iiif/image-api/1.1/compliance.html#level0", "http://iiif.io/api/image/2/level0.json", "level0", "https://iiif.io/api/image/3/level0.json"].indexOf(t);
        t = !1;
    ...
    function u(e) {
        ...
        for (var i = 0; i < e.sizes.length; i++) t.push({
            url: e._id + "/full/" + e.sizes[i].width + "," + (3 === e.version ? e.sizes[i].height : "") + "/0/default." + e.tileFormat,
...
!function (h) {
    ...
    h.ReferenceStrip.prototype = {
        setFocus: function (e) {
            var t, i = this.element.querySelector("#" + this.element.id + "-" + e),
                n = h.getElementSize(this.viewer.canvas), o = Number(this.element.style.width.replace("px", "")),
    ...
    function l(e) {
        ...
        if (this.element) {
            var t = Number(this.element.style.marginLeft.replace("px", "")),
                ...
                o = Number(this.element.style.height.replace("px", "")), r = h.getElementSize(this.viewer.canvas);
            if ("horizontal" === this.scroll) {
                if (0 < -e.delta.x) {
                    if (t > -(n - r.x)) {
    ...
    function g(e) {
        if (e.ctrl || e.alt || e.meta) e.preventDefault = !1; else switch (e.keyCode) {
            case 38:
...
!function (d) {
    ...
    d.Tile.prototype = {
        toString: function () {
            ...
            if (this.cacheImageRecord) if (this.loaded) {
                if (!this.element) {
                    var t = this.getImage();
                    if (!t) return;
            ...
            } else d.console.warn("Attempting to draw tile %s when it's not yet loaded.", this.toString()); else d.console.warn("[Tile.drawHTML] attempting to draw tile %s when it's not cached", this.toString())
        }, get image() {
            ...
            var s, a = this.position.times(d.pixelDensityRatio), l = this.size.times(d.pixelDensityRatio);
...
!function (r) {
    ...
    r.Overlay.prototype = {
        _init: function (e) {
            ...
            i = this.size = n.size;
            t = n.rotate;
            if (this.onDraw) this.onDraw(e, i, this.element); else {
                n = this.style;
                n.left = e.x + "px";
                n.top = e.y + "px";
            ...
            this.adjust(t, i);
            var n = 0;
            if (e.getRotation(!0) && this.rotationMode !== r.OverlayRotationMode.NO_ROTATION) if (this.rotationMode === r.OverlayRotationMode.BOUNDING_BOX && null !== this.width && null !== this.height) {
    ...
    a.Drawer.prototype = {
        addOverlay: function (e, t, i, n) {
            ...
            if (this.useCanvas) {
                ...
                if (t) e.clearRect(t.x, t.y, t.width, t.height); else {
                    t = e.canvas;
...
!function (h) {
    h.Viewport = function (e) {
        var t = arguments;
        if ((e = t.length && t[0] instanceof h.Point ? {
            containerSize: t[0],
            contentSize: t[1],
            config: t[2]
        } : e).config) {
    ...
    h.Viewport.prototype = {
        get degrees() {
            ...
            var t, i, n, o = new h.Point(this.centerSpringX.current.value, this.centerSpringY.current.value),
            ...
            n = this._pixelFromPoint(this.zoomPoint, e).minus(t).rotate(-this.getRotation(!0)).divide(this._containerInnerSize.x * n);
            return r.plus(n)
        }, getZoom: function (e) {
            ...
            if (n) {
                ...
                o = s.rotate(-this.getRotation()).getTopLeft().times(a).minus(e.getTopLeft().times(o)).divide(a - o);
                this.zoomTo(a, o, i)
            }
            return this
            ...
            if (i) if (this.rotationPivot) {
                if (!(e - this._oldDegrees)) {
                    this.rotationPivot = null;
                    return this
                }
                this._rotateAboutPivot(e)
            } else this.degreesSpring.resetTo(e); else {
            ...
            return e.minus(t.getTopLeft()).times(this._containerInnerSize.x / t.width).plus(new h.Point(this._margins.left, this._margins.top))
            ...
            return e.minus(new h.Point(this._margins.left, this._margins.top)).divide(this._containerInnerSize.x / t.width).plus(t.getTopLeft())
            ...
            if (this.viewer) {
                ...
                if (1 < i) this.silenceMultiImageWarnings || h.console.error("[Viewport.viewportToImageCoordinates] is not accurate with multi-image; use TiledImage.viewportToImageCoordinates instead."); else if (1 === i) return this.viewer.world.getItemAt(0).viewportToImageCoordinates(e, t, !0)
            }
            ...
            if (this.viewer) {
                var i = this.viewer.world.getItemCount();
                if (1 < i) this.silenceMultiImageWarnings || h.console.error("[Viewport.imageToViewportCoordinates] is not accurate with multi-image; use TiledImage.imageToViewportCoordinates instead."); else if (1 === i) return this.viewer.world.getItemAt(0).imageToViewportCoordinates(e, t, !0)
            }
            ...
            if (this.viewer) {
                ...
                if (1 < r) this.silenceMultiImageWarnings || h.console.error("[Viewport.imageToViewportRectangle] is not accurate with multi-image; use TiledImage.imageToViewportRectangle instead."); else if (1 === r) return this.viewer.world.getItemAt(0).imageToViewportRectangle(e, t, i, n, !0)
            }
            ...
            if (this.viewer) {
                var r = this.viewer.world.getItemCount();
                if (1 < r) this.silenceMultiImageWarnings || h.console.error("[Viewport.viewportToImageRectangle] is not accurate with multi-image; use TiledImage.viewportToImageRectangle instead."); else if (1 === r) return this.viewer.world.getItemAt(0).viewportToImageRectangle(e, t, i, n, !0)
            }
            ...
            if (this.viewer) {
                ...
                if (1 < t) this.silenceMultiImageWarnings || h.console.error("[Viewport.viewportToImageZoom] is not accurate with multi-image."); else if (1 === t) return this.viewer.world.getItemAt(0).viewportToImageZoom(e)
            }
            ...
            if (this.viewer) {
                var t = this.viewer.world.getItemCount();
                if (1 < t) this.silenceMultiImageWarnings || h.console.error("[Viewport.imageToViewportZoom] is not accurate with multi-image."); else if (1 === t) return this.viewer.world.getItemAt(0).imageToViewportZoom(e)
            }
    ...
    y.extend(y.TiledImage.prototype, y.EventSource.prototype, {
        needsDraw: function () {
            ...
            for (var a = i; n <= a; a--) {
                ...
                if (a === n || !r && h >= this.minPixelRatio) r = l = !0; else if (!r) continue;
            ...
            if (!u.loaded) if (u.context2D) this._setTileLoaded(u); else {
            ...
            var a = i.pixelFromPointNoRotate(r, !0), l = i.pixelFromPointNoRotate(r, !1),
                r = i.deltaPixelsFromPointsNoRotate(s, !0), s = i.deltaPixelsFromPointsNoRotate(s, !1),
                s = l.plus(s.divide(2)), s = n.squaredDistanceTo(s);
            ...
            if (0 !== this.opacity && (0 !== e.length || this.placeholderFillStyle)) {
                ...
                if (!n) {
                    this.viewport.getRotation(!0) % 360 != 0 && this._drawer._offsetForRotation({
    ...
    g.TileCache.prototype = {
        numTilesLoaded: function () {
            ...
            if (this._imagesLoadedCount > this._maxImageCacheCount) {
                ...
                var s = null;
                var a, l, h, c, u, d;
                for (var p = this._tilesLoaded.length - 1; 0 <= p; p--) if (!((a = (d = this._tilesLoaded[p]).tile).level <= t || a.beingDrawn)) if (o) {
                    c = a.lastTouchTime;
                    l = o.lastTouchTime;
                    u = a.level;
                    h = o.level;
